...
n_iterations = 10
#dcd_reporter = app.DCDReporter(output_dcd, output_interval, enforcePeriodicBox=True, append=False)
state_data_reporter = app.StateDataReporter('pot_eng.txt', output_interval, step=True, potentialEnergy=True)
comrepo = COMSeparationReporter('separation.txt', output_interval,np.arange(97-14),np.arange(14)+83)  # Replace 100 with desired reporting interval
print('heating...')
...
simulation.step(output_interval*10)
print('starting...')
simulation.reporters.append(comrepo)
#simulation.reporters.append(dcd_reporter)
simulation.reporters.append(state_data_reporter)
r_range = np.linspace(6,1,30)
for i in r_range:
